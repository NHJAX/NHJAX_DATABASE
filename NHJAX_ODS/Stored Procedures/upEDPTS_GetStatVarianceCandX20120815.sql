...
create PROCEDURE [dbo].[upEDPTS_GetStatVarianceCandX20120815] 
(
	@sdate	smalldatetime,
	@edate	smalldatetime
)
...
TakenDate, IsNull(CollectionSampleDesc,'') as Source, 
'' as GramStain, '' as BacteriologyResult, 
LabTestDesc, 
...
on po.OrderTypeId=ot.OrderTypeId
left outer join patient p 
