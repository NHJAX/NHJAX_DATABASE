...
CREATE PROCEDURE [dbo].[upODS_AHLTAMammography_Patient_Diagnosis] AS
...
EXEC dbo.upActivityLog 'Begin AHLTA Mammography Diagnosis',0,@day;
...
SELECT DISTINCT  
	...
	ICD.DiagnosisDesc
FROM vwSTG_AHLTA_MAMMOGRAPHY_ICD9 AS CERV
...
SET @trow = 0
SET @irow = 0
EXEC dbo.upActivityLog 'Fetch AHLTA Mammography Diagnosis',0
...
SET @sirow = 'AHLTA Mammography Diagnosis Inserted: ' + CAST(@irow AS varchar(50))
SET @strow = 'AHLTA Mammography Diagnosis Total: ' + CAST(@trow AS varchar(50))

EXEC dbo.upActivityLog @sirow,0;
EXEC dbo.upActivityLog @strow,0;
EXEC dbo.upActivityLog 'End AHLTA Mammography Diagnosis',0,@day;
