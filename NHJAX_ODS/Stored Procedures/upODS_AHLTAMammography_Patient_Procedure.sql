...
CREATE PROCEDURE [dbo].[upODS_AHLTAMammography_Patient_Procedure] AS
...
EXEC dbo.upActivityLog 'Begin AHLTA Mammography Procedure',0,@day;
...
SELECT DISTINCT  
	...
	CPT.CptDesc
FROM vwSTG_AHLTA_MAMMOGRAPHY_CPT AS CERV
...
SET @trow = 0
SET @irow = 0
EXEC dbo.upActivityLog 'Fetch AHLTA Mammography Procedure',0
...
SET @sirow = 'AHLTA Mammography Procedure Inserted: ' + CAST(@irow AS varchar(50))
SET @strow = 'AHLTA Mammography Procedure Total: ' + CAST(@trow AS varchar(50))

EXEC dbo.upActivityLog @sirow,0;
EXEC dbo.upActivityLog @strow,0;
EXEC dbo.upActivityLog 'End AHLTA Mammography Procedure',0,@day;
