CREATE PROCEDURE [dbo].[GetOtitisMediaAllDx20120815] 
(
...
where d.diagnosistype=0 and d.diagnosiscode in ('382.9', '382.00', '382.4', '382.01', '381.03', '381.01', '381.4', '381.00', '381.04', '381.05', '381.02')
...
where diagnosistype=0 and diagnosiscode in ('382.9', '382.00', '382.4', '382.01', '381.03', '381.01', '381.4', '381.00', '381.04', '381.05', '381.02') 
and patientage < 18
