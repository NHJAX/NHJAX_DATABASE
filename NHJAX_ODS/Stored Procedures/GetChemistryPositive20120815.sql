CREATE PROCEDURE [dbo].[GetChemistryPositive20120815] 
(
	@PatientID	numeric,
...
op.OrderPriorityDesc as Priority, IsNull(PatientDispositionDesc,'') as Disposition,
...
where po.OrderId=@OrderId and  po.PatientID=@PatientID and TakenDate between @StartDate and @EndDate and LEFT(ChemistryResult,1)='P'
order by TakenDate
END