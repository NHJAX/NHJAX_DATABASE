CREATE PROCEDURE [dbo].[GetOtitisMediaDx20120815] 
(
...
where d.diagnosistype=0 and d.diagnosiscode in ('382.9', '382.00', '382.4', '382.01', '381.03')
...
where diagnosistype=0 and diagnosiscode in ('382.9', '382.00', '382.4', '382.01', '381.03') 
and patientage < 18
