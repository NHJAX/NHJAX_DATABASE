...
create PROCEDURE [dbo].[upODS_PrimaryCareManager_20090326] AS
...
EXEC dbo.upActivityLog 'Begin PCM',0;
...
SET @irow = 0
SET @urow = 0
EXEC dbo.upActivityLog 'Fetch PCM',0
...
EXEC dbo.upActivityLog 'End PCM',0;
