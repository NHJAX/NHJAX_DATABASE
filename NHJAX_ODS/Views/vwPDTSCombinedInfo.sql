CREATE VIEW dbo.vwPDTSCombinedInfo
AS
SELECT DISTINCT 
                      ...
                      dbo.FormattedNDC(dbo.vwMDE_PDTS_PROFILE_COLLECTION_F$ACCEPTED_RESPONSE_DETAIL.ACCEPTED_NDC_NUMBER) AS NDCNumber
FROM         dbo.vwMDE_PDTS_PROFILE_COLLECTION_F$ACCEPTED_RESPONSE_DETAIL INNER JOIN
                      ...
                      dbo.vwMDE_PDTS_PROFILE_COLLECTION_F$ACCEPTED_RESPONSE_DETAIL.KEY_PDTS_PROFILE_COLLECTION_FILE = dbo.vwMDE_PDTS_PROFILE_COLLECTION_FILE.KEY_PDTS_PROFILE_COLLECTION_FILE
                       INNER JOIN
                      dbo.PATIENT ON dbo.vwMDE_PDTS_PROFILE_COLLECTION_FILE.PATIENT_IEN = dbo.PATIENT.PatientKey LEFT OUTER JOIN
                      dbo.PHARMACY ON 
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         SortOrder = 1410
         GroupBy = 1350
         Filter = 1', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwPDTSCombinedInfo';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'350
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwPDTSCombinedInfo';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vwPDTSCombinedInfo';
