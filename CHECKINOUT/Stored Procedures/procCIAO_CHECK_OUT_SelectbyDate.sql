CREATE PROCEDURE [dbo].[procCIAO_CHECK_OUT_SelectbyDate]
(
	@sdate datetime,
	@edate datetime
)
...
SET @sdate = dbo.StartOfDay(@sdate)
...
WHERE CO.CheckOutDate BETWEEN @sdate AND @edate
ORDER BY CO.CheckOutDate
