CREATE TABLE [dbo].[LAB_RESULT$CYTOLOGY_NON_GYN] (
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [ind_LAB_RESULT$CYTOLOGY_NON_GYN]
    ON [dbo].[LAB_RESULT$CYTOLOGY_NON_GYN]([KEY_SITE] ASC, [KEY_LAB_RESULT] ASC, [KEY_LAB_RESULT$CYTOLOGY_NON_GYN] ASC);
