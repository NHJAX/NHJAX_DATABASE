CREATE VIEW [dbo].[xxxvwENET_20120223UnmatchedbySerial]
AS
SELECT DISTINCT 
...
FROM         dbo.vwENET_ASSET_MaxbySerial INNER JOIN
                      ...
                      dbo.xxx20120223Inventory AS SUB ON dbo.ASSET.SerialNumber = SUB.me_mfg_serial_id
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 9
         Width = 284
         Width = 1500
         Widt', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'xxxvwENET_20120223UnmatchedbySerial';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'h = 1500
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'xxxvwENET_20120223UnmatchedbySerial';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'xxxvwENET_20120223UnmatchedbySerial';
