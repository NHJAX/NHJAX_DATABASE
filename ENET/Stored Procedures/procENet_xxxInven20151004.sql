...
CREATE PROCEDURE [dbo].[procENet_xxxInven20151004] 
AS
BEGIN
	Declare @pa float
	...
	FETCH NEXT FROM cur INTO @pa, @ser, @ecn, @net, @rm, @aud,@sub,@mod,@cost
