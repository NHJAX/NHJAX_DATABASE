...
create PROCEDURE [dbo].[procENet_xxxInven20151130] 
AS
BEGIN
	Declare @pa float
	...
	FETCH NEXT FROM cur INTO @pa, @ser, @ecn, @net, @rm, @aud,@mod
		...
		BEGIN TRANSACTION 
			...
			SELECT @serX = SerialNumber,
				...
				BEGIN
					...
					@ser,
					'11/30/2015',  --Acq Date
					'2015 Acquisition ' + @net,
					@net,
					@ecn,
					34,  --Project (34 Lifecycle, 68 CDP)
					1,  -- Asset Type
					1,  --Asset Subtype --84 CDP, 1 Desktop
					30,  --AudienceId
					0,  --Leased
					'11/30/2015',  --Inventory Date
					1612,  --Inventory By (9478 Carlos, 1612 Tony)
					60,  --Warr Months
					1147.93,  --Unit Cost
					1,  --Mission Critical
					1,  --Remote Access
					30,  --Upd Source
					19,  --Bldg (19 2091, 1 964) 
					1, --Deck
					@rm,  --Room
