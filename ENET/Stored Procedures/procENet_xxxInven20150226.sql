...
create PROCEDURE [dbo].[procENet_xxxInven20150226] 
AS
BEGIN
	Declare @pa float
	...
	FETCH NEXT FROM cur INTO @pa, @ser, @ecn, @net, @rm, @aud
		...
		BEGIN TRANSACTION 
			...
			SELECT @serX = SerialNumber,
				...
				BEGIN
					...
					1,  --Remote Access
					30,  --Upd Source
					1,  --Bldg (19 2091, 1 964) 
					1, --Deck
					@rm,  --Room
					1,   --Disposition (19 techshop, 1 active)
					100  --Manufacturer
					)
