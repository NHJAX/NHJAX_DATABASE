CREATE PROCEDURE [dbo].[procENET_Asset_SelectInto]
(
	@ast 		int = 0,
	@tech		int = 0,
	@all		int = 0,
...
DECLARE	
	...
	DELETE FROM sessASSET
	WHERE TechId = @tech
	
SELECT @sql = 'INSERT INTO sessASSET
	(
		AsssetId, 
		ModelId, 
		ModelDesc,
	...
	TECH.ULName + '', '' + TECH.UFName + '' '' + ISNULL(TECH.UMName,''''),   
	TECH1.UserId AS CById, 
	TECH1.ULName + '', '' + TECH1.UFName + '' '' + ISNULL(TECH1.UMName,''''),  
    AST.CreatedDate, 
	TECH2.UserId AS UById, 
	TECH2.ULName + '', '' + TECH2.UFName + '' '' + ISNULL(TECH2.UMName,''''), 
	AST.UpdatedDate, 
	AST.InventoryDate, 
	AST.PrinterConfig, 
	AST.SharePC, 
